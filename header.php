...
<html class="no-js">
    <head>
        <title>AIUB</title>
		<meta name="description" content="WHERE LEADERS ARE CREATED. ">
		<meta name="keywords" content="AMERICAN INTERNATIONAL UNIVERSITY BANGLADESH <AIUB">
		<meta charset="UTF-8">
        <!-- Bootstrap -->
				<link href="admin/images/New folder/Aiub.ico" rel="icon" type="image">

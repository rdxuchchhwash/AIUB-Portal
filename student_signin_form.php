			...
			<button id="signin" name="login" class="btn btn-success" type="submit"><i class="icon-check icon-large"></i> Sign up</button>
			</form>
			...
			jQuery("#signin_student").submit(function(e){
					...
					$.ajax({
						...
						if(html=='true')
						{
						$.jGrowl("Welcome to Online Course Management System", { header: 'Sign up Success' });
						var delay = 2000;
